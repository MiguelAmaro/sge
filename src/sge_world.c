...
inline void
World_change_entity_location(World * world, u32 index_low,
...
World_tilecoord_to_chunkcoord(World *world, s32 tile_abs_x, s32 tile_abs_y, s32 tile_abs_z)
{
    ...
    result.chunk_x = tile_abs_x / WORLD_TILES_PER_CHUNK;
    result.chunk_y = tile_abs_y / WORLD_TILES_PER_CHUNK;
    result.chunk_z = tile_abs_z / WORLD_TILES_PER_CHUNK;
    
    result.rel_.x = (f32)(tile_abs_x - (result.chunk_x * WORLD_TILES_PER_CHUNK)) * world->side_in_meters_tile;
    result.rel_.y = (f32)(tile_abs_y - (result.chunk_y * WORLD_TILES_PER_CHUNK)) * world->side_in_meters_tile;
